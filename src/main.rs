...
fn generer_valeur(type_valeur: &String, colonne: &String) -> String {
    ...
    if vec![&String::from("TEXT"), &String::from("VARCHAR")].contains(&&type_valeur.to_uppercase()) {
        ...
        if vec![&String::from("NOM"), &String::from("NAME")].contains(&&colonne.to_uppercase()) {
        ...
        } else if vec![&String::from("PRENOM"), &String::from("FIRSTNAME"), &String::from("FIRST-NAME"), &String::from("FIRST NAME")].contains(&&colonne.to_uppercase()) {
        ...
        } else if vec![&String::from("MOT DE PASSE"), &String::from("MOTDEPASSE"), &String::from("MDP"), &String::from("PASSWORD"), &String::from("PASSWD"), &String::from("MOT_DE_PASSE")].contains(&&colonne.to_uppercase()){
